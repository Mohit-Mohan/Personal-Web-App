    ...
    <div className="container about">
      ...
      <div className="row">
        <div className="col-md-6 about_the_website_text ">
          ...
          <p>
          A synthesis of design and technology, this website is an attempt to showcase my knowledge, practical experience, and technical competence in the fields of Project Management and Design, along with some projects I am passionate about. Each project of mine has a story of its own with one particularly unique underlying commonality – dragons. </p>
