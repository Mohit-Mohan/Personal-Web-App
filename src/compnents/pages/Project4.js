...
const Project4 = () => {
  return (
    ...
    <div className=" text-center app_interface_text brief_text_white_bg" style={{marginTop:"5%"}} >Blok-1 redefines conventional music notation and creation. It enables each user to make their own beats and music while grasping a more intuitive and deeper understanding of traditional sheet music notation</div>
    ...
    <div className="text_center app_interface_text brief_text_white_bg">Each blok on the conductive grid contains a unique resistance value which allows it to produce distinct sounds based on user input and placement.</div>
      ...
      <div className="text_center app_interface_text brief_text_white_bg">The Blok - 1 application aims to create an inclusive music community of not just skilled musicians but also those who are alienated by society because of their subtle learning differences. It provides everyone a platform to learn and create new beats as well as share them.</div>
      <div >
